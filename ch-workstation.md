...
```r
base::source("https://gist.githubusercontent.com/wibeasley/2c5e7459b88ec28b9e8fa0c695b15ee3/raw")
...
1. Environment | More Settings | Fonts and Colors | Show settings for: Grid Results | Size: 12
...
1. Text Editor | Editor Tab and Status Bar<sup>1</sup> | Tab Text | Include Server Name: false
1. Text Editor | Editor Tab and Status Bar<sup>1</sup> | Tab Text | Include Database Name: false
1. Text Editor | Editor Tab and Status Bar<sup>1</sup> | Tab Text | Include Login Name: false
1. Text Editor | All Languages | General | Line Numbers: true

Note 1: For SSMS V21 only, "Editor Tab and Status Bar" was nested in "SQL Server Tools | Transact-SQL Editor".
