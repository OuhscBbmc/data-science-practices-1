...
\KeywordTok{(} \KeywordTok{function}\FunctionTok{ install-packages} \KeywordTok{\{}
  ...
  \CommentTok{# The 'xml2' package; https://CRAN.R-project.org/package=xml2 }
  \FunctionTok{sudo}\NormalTok{ apt-get --yes install libxml2-dev r-cran-xml}

  \CommentTok{# The 'curl' package, and others; https://CRAN.R-project.org/package=curl }
  ...
  \CommentTok{# The 'rgl' package; https://stackoverflow.com/a/39952771/1082435}
  \FunctionTok{sudo}\NormalTok{ apt-get --yes install libcgal-dev libglu1-mesa-dev}

  \CommentTok{# The 'magick' package; https://docs.ropensci.org/magick/articles/intro.html#build-from-source}
  ...
  \CommentTok{# old: sudo add-apt-repository ppa:ubuntugis/ubuntugis-unstable}
  \CommentTok{# old: sudo apt-get update}
  ...
  \CommentTok{# 'rJava' and others; https://www.r-bloggers.com/installing-rjava-on-ubuntu/}
