...
\end{Shaded}
\item
  \texttt{dplyr::na\_if()} transforms a nonmissing value into an NA.
...
\hypertarget{filtering-rows-style-filter}{%
\subsection{Filtering Rows \{\#style-filter)}\label{filtering-rows-style-filter}}
