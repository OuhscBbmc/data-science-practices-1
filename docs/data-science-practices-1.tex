...
\hypertarget{prefix-with-ds_-and-d_}{%
\subsubsection{\texorpdfstring{Prefix with \texttt{ds\_} and \texttt{d\_}}{Prefix with ds\_ and d\_}}\label{prefix-with-ds_-and-d_}}
...
\hypertarget{express-the-grain}{%
\subsubsection{Express the grain}\label{express-the-grain}}
...
\hypertarget{use-ds-when-definition-is-clear}{%
\subsubsection{\texorpdfstring{Use \texttt{ds} when definition is clear}{Use ds when definition is clear}}\label{use-ds-when-definition-is-clear}}

Many times an \protect\hyperlink{pattern-ellis}{ellis file} deals with only one incoming csv and outgoing dataset, and the grain is obvious --typically because the ellis filename clearly states the grain.

\hypertarget{use-an-adjective-after-the-grain-if-necessary}{%
\subsubsection{Use an adjective after the grain, if necessary}\label{use-an-adjective-after-the-grain-if-necessary}}
...
\hypertarget{define-the-dataset-when-in-doubt}{%
\subsubsection{Define the dataset when in doubt}\label{define-the-dataset-when-in-doubt}}
